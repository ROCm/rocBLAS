...
/*! \brief BLAS EX API
    ...
    @param[in, out]
    startEvent         [void *]
              optional pointer to hipEvent used for marking start of profiling.

    @param[in, out]
    stopEvent         [void *]
              optional pointer to hipEvent used for marking end of profiling.
...
/* For backward compatiblity, unused workspace_size and workspace arguments are ignored */
// clang-format off
#define rocblas_gemm_ex_profile(handle,         \
                        transA,         \
                        transB,         \
                        m,              \
                        n,              \
                        ...
                        stopEvent,      \
                        ...)            \
                        ROCBLAS_VA_OPT_PRAGMA(GCC warning "rocblas_gemm_ex_profile: The workspace_size and workspace arguments are obsolete, and will be ignored", __VA_ARGS__) \
        rocblas_gemm_ex_profile(handle,         \
                        transA,         \
                        transB,         \
                        m,              \
                        n,              \
