...
public:
    ...
    RocblasContractionProblem(ContractionProblemType problem_type,
                              ...
                              const T*          beta,
                              T*                C,
                              unsigned long       ld_c): problem_type(problem_type), 
                                                         trans_a(trans_a),trans_b(trans_b),
                                                         m(m),n(n),k(k),alpha(alpha),
                                                         A(A),ld_a(ld_a),B(B),stride_a(1),ld_b(ld_b),stride_b(1),beta(beta),
                                                         C(C),ld_c(ld_c),stride_c(1),batch_size(1)
    ...
    RocblasContractionProblem(ContractionProblemType problem_type,
                              ...
                              unsigned long       ld_c,
                              unsigned long     stride_c,
                              unsigned long     batch_size): problem_type(problem_type),
                                                         trans_a(trans_a),trans_b(trans_b),
                                                         m(m),n(n),k(k),alpha(alpha),
                                                         A(A),ld_a(ld_a),B(B),stride_a(stride_a),ld_b(ld_b),stride_b(stride_b),beta(beta),
                                                         C(C),ld_c(ld_c),stride_c(stride_c),batch_size(batch_size)
    {
    }
