...
#ifndef ROCBLAS_SCAL_HPP
#define ROCBLAS_SCAL_HPP
...
rocblas_scal_template(rocblas_handle handle, rocblas_int n, const T* alpha, T* x, rocblas_int incx)
{
    ...
    {
        log_trace(handle, replaceX<T>("rocblas_Xscal"), n, *alpha, (const void*&)x, incx);
    ...
    rocblas_int blocks = (n - 1) / NB_X_SCAL + 1;

    dim3 grid(blocks, 1, 1);
    dim3 threads(NB_X_SCAL, 1, 1);
