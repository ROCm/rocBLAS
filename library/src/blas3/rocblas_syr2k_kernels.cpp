...
// clang-format off
#ifdef INSTANTIATE_SYR2K_HER2K_KERNEL
#error INSTANTIATE_SYR2K_HER2K_KERNEL already defined
#endif

#define INSTANTIATE_SYR2K_HER2K_KERNEL(TWOK, HERM, TRANS, DIM_XYT, TScal, TConstPtr, TPtr) \
template ROCBLAS_KERNEL_INSTANTIATE __launch_bounds__(DIM_XYT* DIM_XYT) void syr2k_her2k_kernel        \
                                <TWOK, HERM, TRANS, DIM_XYT, TScal, TConstPtr, TPtr>       \
                                (bool              upper,                                  \
                                 rocblas_operation trans,                                  \
                                 rocblas_int       n,                                      \
                                 rocblas_int       k,                                      \
...
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_float_complex const*, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_float_complex const*, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_float_complex, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_float_complex, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_double_complex const*, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_double_complex const*, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_double_complex, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_double_complex, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_float_complex const*, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_float_complex const*, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_float_complex, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_float_complex, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_double_complex const*, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_double_complex const*, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, false, 32, rocblas_double_complex, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(true, true, true, 32, rocblas_double_complex, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_float_complex const*, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_float_complex const*, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_float_complex, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_float_complex, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_double_complex const*, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_double_complex const*, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_double_complex, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_double_complex, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_float_complex const*, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_float_complex const*, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_float_complex, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_float_complex, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_double_complex const*, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_double_complex const*, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, false, 32, rocblas_double_complex, rocblas_double_complex const* const*, rocblas_double_complex* const*)
INSTANTIATE_SYR2K_HER2K_KERNEL(false, true, true, 32, rocblas_double_complex, rocblas_double_complex const* const*, rocblas_double_complex* const*)

#undef INSTANTIATE_SYR2K_HER2K_KERNEL

#ifdef INSTANTIATE_SYR2K_ARG_CHECK
#error INSTANTIATE_SYR2K_ARG_CHECK already defined
#endif

#define INSTANTIATE_SYR2K_ARG_CHECK(TScal, TConstPtr, TPtr)                     \
template rocblas_status rocblas_syr2k_arg_check<TScal, TConstPtr, TPtr>         \
...
INSTANTIATE_SYR2K_ARG_CHECK(float const*, float const*, float*)
INSTANTIATE_SYR2K_ARG_CHECK(double const*, double const*, double*)
INSTANTIATE_SYR2K_ARG_CHECK(rocblas_float_complex const*, rocblas_float_complex const*, rocblas_float_complex*)
INSTANTIATE_SYR2K_ARG_CHECK(rocblas_double_complex const*, rocblas_double_complex const*, rocblas_double_complex*)
INSTANTIATE_SYR2K_ARG_CHECK(float const*, float const* const*, float* const*)
INSTANTIATE_SYR2K_ARG_CHECK(double const*, double const* const*, double* const*)
INSTANTIATE_SYR2K_ARG_CHECK(rocblas_float_complex const*, rocblas_float_complex const* const*, rocblas_float_complex* const*)
INSTANTIATE_SYR2K_ARG_CHECK(rocblas_double_complex const*, rocblas_double_complex const* const*, rocblas_double_complex* const*)

#undef INSTANTIATE_SYR2K_ARG_CHECK

#ifdef INSTANTIATE_SYR2K_TEMPLATE
#error INSTANTIATE_SYR2K_TEMPLATE already defined
#endif

#define INSTANTIATE_SYR2K_TEMPLATE(TWOK, TScal, TConstPtr, TPtr)                         \
template ROCBLAS_INTERNAL_EXPORT_NOINLINE rocblas_status rocblas_internal_syr2k_template \
                                <TWOK, TScal, TConstPtr, TPtr>                           \
				(rocblas_handle    handle,                               \
                                 rocblas_fill      uplo,                                 \
                                 rocblas_operation trans,                                \
                                 rocblas_int       n,                                    \
