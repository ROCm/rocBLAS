 ...
 */
template <typename T, typename SCAL, typename ATYPE, typename BTYPE, const int NB>
void rocblas_trsm_small(rocblas_side      side,
                        rocblas_fill      uplo,
                        rocblas_operation transA,
                        rocblas_diagonal  diag,
                        rocblas_int       m,
...
void rocblas_trsm_small_64(rocblas_side      side,
                           rocblas_fill      uplo,
                           rocblas_operation transA,
                           rocblas_diagonal  diag,
                           rocblas_int       m,
                           ...
                           rocblas_int       batch_count)
{
    rocblas_trsm_small<T, SCAL, ATYPE, BTYPE, NB>(side,
                                                  uplo,
                                                  transA,
                                                  diag,
                                                  m,
                                                             ...
                                                             rocblas_stride stride_invA        = 0)
{
    ...
    {
        if(k <= 2)
            rocblas_trsm_small<T, T, U, V, 2>(side,
                                              uplo,
                                              transA,
                                              diag,
                                              m,
            ...
            rocblas_trsm_small<T, T, U, V, 4>(side,
                                              uplo,
                                              transA,
                                              diag,
                                              m,
            ...
            rocblas_trsm_small<T, T, U, V, 8>(side,
                                              uplo,
                                              transA,
                                              diag,
                                              m,
            ...
            rocblas_trsm_small<T, T, U, V, 16>(side,
                                               uplo,
                                               transA,
                                               diag,
                                               m,
            ...
            rocblas_trsm_small<T, T, U, V, 32>(side,
                                               uplo,
                                               transA,
                                               diag,
                                               m,
            ...
            rocblas_trsm_small_64<T, T, U, V, 64>(side,
                                                  uplo,
                                                  transA,
                                                  diag,
                                                  m,
