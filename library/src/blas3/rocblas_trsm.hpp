                                             ...
                                             rocblas_int       supplied_invA_size = 0)
{
    ...
    else
    {
        ...
        status = rocblas_trtri_trsm_batched_template<BLOCK>(
            handle, (T**)x_temparr, uplo, diag, k, A, lda, (T**)invAarr, batch_count);
    ...
    else
    {
        ...
        if(status == rocblas_status_success)
            copy_block_unit(handle, m, n, (const T**)x_temparr, m, B, ldb, batch_count);
    }
