                                        ...
                                        T* x_temp)
{
    ...
    //         handle, side, uplo, trA, diag, m, n, alpha, A, lda, B, ldb, invA, ldInvA, x_temp);
    // }
                                ...
                                float* x_temp)
{
    ...
    return rocblas_trsm_ex_template<STRSM_BLOCK>(
        handle, side, uplo, transA, diag, m, n, alpha, A, lda, B, ldb, invA, ldInvA, x_temp);
}
