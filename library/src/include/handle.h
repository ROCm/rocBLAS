...
struct _rocblas_handle
{
    ...
    // trsm get pointers
    void* get_trsm_Y() const
    {
        return trsm_Y;
    }
    void* get_trsm_invA() const
    {
        return trsm_invA;
    }
    void* get_trsm_invA_C() const
    {
        return trsm_invA_C;
    }
    const size_t* get_trsm_A_blks()
    {
        return &WORKBUF_TRSM_A_BLKS;
    }
    const size_t* get_trsm_B_chnk()
    {
        return &WORKBUF_TRSM_B_CHNK;
    }

    // trsv get pointers
    void* get_trsv_x() const
    {
        return trsv_x;
    }
    void* get_trsv_alpha() const
    {
        return trsv_alpha;
    }
    void* get_trsv_one() const
    {
        return trsv_one;
    }
    void* get_trsv_zero() const
    {
        return trsv_zero;
    }
    void* get_trsv_negative_one() const
    {
        return trsv_negative_one;
    }
    const size_t* get_trsv_X_size()
    {
        return &WORKBUF_TRSV_X_SZ;
    }
