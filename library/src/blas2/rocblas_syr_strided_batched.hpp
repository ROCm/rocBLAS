            ...
            | rocblas_layer_mode_log_profile))
    {
        ...
        if(handle->pointer_mode == rocblas_pointer_mode_host)
        {
            if(layer_mode & rocblas_layer_mode_log_trace)
                log_trace(handle, rocblas_syr_strided_batched_name<T>, uplo, n, *alpha, x, incx, A, lda, batch_count);
        ...
        {
            if(layer_mode & rocblas_layer_mode_log_trace)
                log_trace(handle, rocblas_syr_strided_batched_name<T>, uplo, n, alpha, x, incx, stridex, A, lda, strideA, batch_count);
        }
