...
/**
  ...
  *
  *  1 2 0 0 0              0 2 2 2 2
  *  3 1 2 0 0              1 1 1 1 1    <- (ku+1)'th row = (1+1)'th row = 2nd row
  *  4 3 1 2 0     ---->    3 3 3 3 0
  *  0 4 3 1 9              4 4 4 0 0
  *  0 0 4 3 1              0 0 0 0 0
  *
                             ...
                             rocblas_int       stridey)
{
    ...
    gbmvx_kernel_calc<DIM_X, DIM_Y>(transA, m, n, kl, ku, A, lda, x, incx, y, incy);
}

/**
  *  Here, U is either a `const T* const*` or a `const T*`
  *  V is either a `T*` or a `T* const*`
  *  W is either a const T*
  */
                                     ...
                                     rocblas_int       batch_count)
{
    ...
    rocblas_int          blocks      = (m - 1) / (GBMVX_DIM_X) + 1;
