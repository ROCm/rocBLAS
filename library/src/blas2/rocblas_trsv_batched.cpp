...
namespace
{
                                                ...
                                                rocblas_int       supplied_invA_size = 0)
    {
        ...
        rocblas_status perf_status = rocblas_trsv_template_mem<BLOCK, true, T>(handle,
                                                                               m,
                                                                               batch_count,
                                                                               mem,
                                                                               mem_x_temp,
        ...
        if(check_numerics)
        {
            ...
            rocblas_status trsv_check_numerics_status
                = rocblas_trsv_check_numerics(rocblas_trsv_batched_name<T>,
                                              handle,
                                              m,
                                              A,
                                              0,
        ...
        rocblas_status status = rocblas_trsv_template<BLOCK, true, T>(handle,
                                                                      uplo,
                                                                      transA,
                                                                      diag,
                                                                      m,
