...
template <typename T>
void testing_trmm_strided_batched_ex_bad_arg(const Arguments& arg)
{
    auto rocblas_trmm_strided_batched_ex_fn = arg.fortran
                                                  ? rocblas_trmm_strided_batched_ex<T, true>
                                                  : rocblas_trmm_strided_batched_ex<T, false>;
    ...
    EXPECT_ROCBLAS_STATUS(rocblas_trmm_strided_batched_ex_fn(handle,
                                                             side,
                                                             uplo,
                                                             transA,
                                                             diag,
    ...
    EXPECT_ROCBLAS_STATUS(rocblas_trmm_strided_batched_ex_fn(nullptr,
                                                             side,
                                                             uplo,
                                                             transA,
                                                             diag,
...
template <typename T>
void testing_trmm_strided_batched_ex(const Arguments& arg)
{
    auto rocblas_trmm_strided_batched_ex_fn = arg.fortran
                                                  ? rocblas_trmm_strided_batched_ex<T, true>
                                                  : rocblas_trmm_strided_batched_ex<T, false>;
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR(rocblas_trmm_strided_batched_ex_fn(handle,
                                                               side,
                                                               uplo,
                                                               transA,
                                                               diag,
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_trmm_strided_batched_ex_fn(handle,
                                               side,
                                               uplo,
                                               transA,
                                               diag,
