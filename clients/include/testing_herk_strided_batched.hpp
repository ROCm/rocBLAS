...
void testing_herk_strided_batched_bad_arg(const Arguments& arg)
{
    ...
    EXPECT_ROCBLAS_STATUS((rocblas_herk_strided_batched<T, U>)(nullptr,
                                                               uplo,
                                                               transA,
                                                               N,
                                                               K,
...
void testing_herk_strided_batched(const Arguments& arg)
{
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR((rocblas_herk_strided_batched<T, U>)(handle,
                                                                 uplo,
                                                                 transA,
                                                                 N,
                                                                 K,
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_herk_strided_batched<T, U>(handle,
                                               uplo,
                                               transA,
                                               N,
                                               K,
