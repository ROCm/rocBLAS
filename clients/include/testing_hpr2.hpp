...
void testing_hpr2_bad_arg()
{
    ...
    EXPECT_ROCBLAS_STATUS((rocblas_hpr2<T>)(handle, uplo, N, &alpha, nullptr, incx, dy, incy, dA_1),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2<T>)(handle, uplo, N, &alpha, dx, incx, nullptr, incy, dA_1),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2<T>)(handle, uplo, N, &alpha, dx, incx, dy, incy, nullptr),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2<T>)(nullptr, uplo, N, &alpha, dx, incx, dy, incy, dA_1),
...
void testing_hpr2(const Arguments& arg)
{
    ...
    {
        EXPECT_ROCBLAS_STATUS(
            (rocblas_hpr2<T>)(handle, uplo, N, nullptr, nullptr, incx, nullptr, incy, nullptr),
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR((rocblas_hpr2<T>)(handle, uplo, N, &h_alpha, dx, incx, dy, incy, dA_1));

        CHECK_ROCBLAS_ERROR(rocblas_set_pointer_mode(handle, rocblas_pointer_mode_device));
        CHECK_ROCBLAS_ERROR((rocblas_hpr2<T>)(handle, uplo, N, d_alpha, dx, incx, dy, incy, dA_2));
        ...
        cblas_hpr2<T>(uplo, N, h_alpha, hx, incx, hy, incy, hA_gold);
        cpu_time_used = get_time_us() - cpu_time_used;
        cblas_gflops  = hpr2_gflop_count<T>(N) / cpu_time_used * 1e6;
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_hpr2<T>(handle, uplo, N, &h_alpha, dx, incx, dy, incy, dA_1);
        }
        ...
        rocblas_cout << "N,alpha,incx,incy,rocblas-Gflops,rocblas-GB/s";
