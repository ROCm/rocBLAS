...
void testing_hpr2_bad_arg(const Arguments& arg)
{
    ...
    EXPECT_ROCBLAS_STATUS(
        (rocblas_hpr2_fn)(handle, rocblas_fill_full, N, &alpha, dx, incx, dy, incy, dA_1),
        rocblas_status_invalid_value);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2_fn)(handle, uplo, N, &alpha, nullptr, incx, dy, incy, dA_1),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2_fn)(handle, uplo, N, &alpha, dx, incx, nullptr, incy, dA_1),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2_fn)(handle, uplo, N, &alpha, dx, incx, dy, incy, nullptr),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_hpr2_fn)(nullptr, uplo, N, &alpha, dx, incx, dy, incy, dA_1),
...
void testing_hpr2(const Arguments& arg)
{
    ...
    // Matrix `hA_1` is initialized as a triangular matrix because only the upper triangular or lower triangular portion of the matrix `hA_1` is referenced.
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR((rocblas_hpr2_fn)(handle, uplo, N, &h_alpha, dx, incx, dy, incy, dA_1));

        CHECK_ROCBLAS_ERROR(rocblas_set_pointer_mode(handle, rocblas_pointer_mode_device));
        CHECK_ROCBLAS_ERROR((rocblas_hpr2_fn)(handle, uplo, N, d_alpha, dx, incx, dy, incy, dA_2));
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_hpr2_fn(handle, uplo, N, &h_alpha, dx, incx, dy, incy, dA_1);
        }
