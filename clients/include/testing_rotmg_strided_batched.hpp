...
void testing_rotmg_strided_batched_bad_arg(const Arguments& arg)
{
    ...
    EXPECT_ROCBLAS_STATUS(
        (rocblas_rotmg_strided_batched<T>(nullptr, d1, 0, d2, 0, x1, 0, y1, 0, param, batch_count)),
        rocblas_status_invalid_handle);
    EXPECT_ROCBLAS_STATUS((rocblas_rotmg_strided_batched<T>(
                              handle, nullptr, 0, d2, 0, x1, 0, y1, 0, param, batch_count)),
                          rocblas_status_invalid_pointer);
    EXPECT_ROCBLAS_STATUS((rocblas_rotmg_strided_batched<T>(
                              handle, d1, 0, nullptr, 0, x1, 0, y1, 0, param, batch_count)),
                          rocblas_status_invalid_pointer);
    EXPECT_ROCBLAS_STATUS((rocblas_rotmg_strided_batched<T>(
                              handle, d1, 0, d2, 0, nullptr, 0, y1, 0, param, batch_count)),
                          rocblas_status_invalid_pointer);
    EXPECT_ROCBLAS_STATUS((rocblas_rotmg_strided_batched<T>(
                              handle, d1, 0, d2, 0, x1, 0, nullptr, 0, param, batch_count)),
                          rocblas_status_invalid_pointer);
    EXPECT_ROCBLAS_STATUS((rocblas_rotmg_strided_batched<T>(
                              handle, d1, 0, d2, 0, x1, 0, y1, 0, nullptr, batch_count)),
                          rocblas_status_invalid_pointer);
}
