...
template <>
static constexpr auto rocblas_axpy_strided_batched<rocblas_float_complex> = rocblas_caxpy_strided_batched;

template <>
static constexpr auto rocblas_axpy_strided_batched<rocblas_double_complex> = rocblas_zaxpy_strided_batched;
