...
rocblas_status testing_axpy(Arguments argus)
{
    ...
    //copy vector is easy in STL; hy_ref = hx: save a copy in hy_ref which will be output of CPU BLAS
    hy_ref = hy;
    ...
    if(argus.unit_check || argus.norm_check){
     ...
     =================================================================== */
        ...
        if(argus.unit_check){
            unit_check_general<T>(1, N, incy, hy_ref.data(), hy.data());
        }
        ...
        if(argus.norm_check){
            rocblas_error = norm_check_general<T>('F', 1, N, incy, hy_ref.data(), hy.data());
        }
