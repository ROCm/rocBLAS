...
template <typename T>
void testing_hpr2_strided_batched_bad_arg()
{
    ...
    EXPECT_ROCBLAS_STATUS((rocblas_hpr2_strided_batched<T>)(nullptr,
                                                            uplo,
                                                            N,
                                                            &alpha,
                                                            dx,
...
void testing_hpr2_strided_batched(const Arguments& arg)
{
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR((rocblas_hpr2_strided_batched<T>)(handle,
                                                              uplo,
                                                              N,
                                                              &h_alpha,
                                                              dx,
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_hpr2_strided_batched<T>(handle,
                                            uplo,
                                            N,
                                            &h_alpha,
                                            dx,
