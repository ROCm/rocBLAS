...
void testing_her_bad_arg()
{
    ...
    EXPECT_ROCBLAS_STATUS(
        (rocblas_her<T, U>)(handle, rocblas_fill_full, N, &alpha, dx, incx, dA_1, lda),
        rocblas_status_invalid_value);

    EXPECT_ROCBLAS_STATUS((rocblas_her<T, U>)(handle, uplo, N, &alpha, nullptr, incx, dA_1, lda),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_her<T, U>)(handle, uplo, N, &alpha, dx, incx, nullptr, lda),
                          rocblas_status_invalid_pointer);

    EXPECT_ROCBLAS_STATUS((rocblas_her<T, U>)(nullptr, uplo, N, &alpha, dx, incx, dA_1, lda),
...
void testing_her(const Arguments& arg)
{
    ...
    {
        EXPECT_ROCBLAS_STATUS(
            (rocblas_her<T, U>)(handle, uplo, N, nullptr, nullptr, incx, nullptr, lda),
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR((rocblas_her<T, U>)(handle, uplo, N, &h_alpha, dx, incx, dA_1, lda));

        CHECK_ROCBLAS_ERROR(rocblas_set_pointer_mode(handle, rocblas_pointer_mode_device));
        CHECK_ROCBLAS_ERROR((rocblas_her<T, U>)(handle, uplo, N, d_alpha, dx, incx, dA_2, lda));
        ...
        cblas_her<T, U>(uplo, N, h_alpha, hx, incx, hA_gold, lda);
        cpu_time_used = get_time_us() - cpu_time_used;
        cblas_gflops  = her_gflop_count<T>(N) / cpu_time_used * 1e6;
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_her<T, U>(handle, uplo, N, &h_alpha, dx, incx, dA_1, lda);
        }
        ...
        rocblas_gflops    = her_gflop_count<T>(N) / gpu_time_used * 1e6;
        rocblas_bandwidth = her_gbyte_count<T>(N) / gpu_time_used * 1e6;

        // only norm_check return an norm error, unit check won't return anything
        rocblas_cout << "N,alpha,lda,incx,rocblas-Gflops,rocblas-GB/s";
        ...
        rocblas_cout << N << "," << h_alpha << "," << lda << "," << incx << "," << rocblas_gflops
                     << "," << rocblas_bandwidth;
