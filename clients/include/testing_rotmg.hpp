...
void testing_rotmg(const Arguments& arg)
{
    ...
    for (int i = 0; i < TEST_COUNT; ++i)
    {
        ...
        // Test rocblas_pointer_mode_host
        {
            ...
            CHECK_ROCBLAS_ERROR(rocblas_rotmg<T>(handle, &hparams[0], &hparams[1], &hparams[2], &hparams[3], &hparams[4]));
        ...
        // Test rocblas_pointer_mode_device
        {
            ...
            CHECK_ROCBLAS_ERROR(rocblas_rotmg<T>(handle, dparams, dparams + 1, dparams + 2, dparams + 3, dparams + 4));
    ...
    if (arg.timing)
    {
        ...
        {
            rocblas_rotmg<T>(handle, &hparams[0], &hparams[1], &hparams[2], &hparams[3], &hparams[4]);
        }
